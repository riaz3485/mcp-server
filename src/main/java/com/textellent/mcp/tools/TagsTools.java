...
public class TagsTools {
    ...
    @ManagedTool
    @McpTool(name = "tags_create", description = "Create tags")
    ...
    @ManagedTool
    @McpTool(name = "tags_update", description = "Update tag")
    ...
    @ManagedTool
    @McpTool(name = "tags_get", description = "Get tag")
    ...
    @ManagedTool
    @McpTool(name = "tags_get_all", description = "List tags")
    ...
    @ManagedTool
    @McpTool(name = "tags_get_summary", description = "Get tag summary")
    ...
    @ManagedTool
    @McpTool(name = "tags_assign_contacts", description = "Assign contacts to tag")
    ...
    @ManagedTool
    @McpTool(name = "tags_delete", description = "Delete tag")
    ...
    @ManagedTool
    @McpTool(name = "tags_remove_contacts", description = "Remove contacts from tag")
