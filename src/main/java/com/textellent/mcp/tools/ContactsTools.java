...
public class ContactsTools {
    ...
    @ManagedTool
    @McpTool(name = "contacts_add", description = "Add contacts")
    ...
    @ManagedTool
    @McpTool(name = "contacts_update", description = "Update contact")
    ...
    @ManagedTool
    @McpTool(name = "contacts_get_all", description = "List contacts")
    ...
    @ManagedTool
    @McpTool(name = "contacts_get_summary", description = "Get contact summary")
    ...
    @ManagedTool
    @McpTool(name = "contacts_get", description = "Get contact by ID")
    ...
    @ManagedTool
    @McpTool(name = "contacts_delete", description = "Delete contact")
    ...
    @ManagedTool
    @McpTool(name = "contacts_find_multiple_phones", description = "Find contact by multiple phones")
    ...
    @ManagedTool
    @McpTool(name = "contacts_find", description = "Find contact")
